...
const strategy_1 = __webpack_require__(20);
...
__decorate([
    ...
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [typeof (_c = typeof dto_1.AuthDto !== "undefined" && dto_1.AuthDto) === "function" ? _c : Object]),
    __metadata("design:returntype", Promise)
...
const argon = __webpack_require__(13);
const library_1 = __webpack_require__(14);
const jwt_1 = __webpack_require__(15);
const config_1 = __webpack_require__(7);
let AuthService = class AuthService {
    ...
    async signin(dto) {
        ...
        if (!profile)
            throw new common_1.ForbiddenException('Credentials are wrong');
    ...
    async signup(dto) {
        try {
            ...
            if (error instanceof library_1.PrismaClientKnownRequestError) {
                if (error.code === 'P2002') {
                    throw new common_1.ForbiddenException('Credentials already in use');
                }
            }
            else
                throw error;
    ...
    async signToken(profileId, email) {
...
const common_1 = __webpack_require__(6);
exports.GetProfile = (0, common_1.createParamDecorator)((data, ctx) => {
